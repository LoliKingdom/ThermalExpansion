...
public class ItemUpgrade extends ItemMulti implements IInitializer, IUpgradeItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        switch (type) {
            case INCREMENTAL:
                tooltip.add(StringHelper.getInfoText("info.thermalfoundation.upgrade.incremental.0"));
                tooltip.add(StringHelper.getNoticeText("info.thermalfoundation.upgrade.incremental.1"));
                break;
            case FULL:
                tooltip.add(StringHelper.getInfoText("info.thermalfoundation.upgrade.full.0"));
                tooltip.add(StringHelper.getNoticeText("info.thermalfoundation.upgrade.full.1"));
                break;
            case CREATIVE:
                tooltip.add(StringHelper.getInfoText("info.thermalfoundation.upgrade.creative.0"));
                tooltip.add(StringHelper.getNoticeText("info.thermalfoundation.upgrade.creative.1"));
                break;
            default:
        }
    }
