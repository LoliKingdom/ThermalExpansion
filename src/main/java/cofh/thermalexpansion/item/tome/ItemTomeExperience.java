package cofh.thermalexpansion.item.tome;
...
public class ItemTomeExperience extends ItemTome implements IFluidContainerItem, IEnchantableItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(StringHelper.getInfoText("info.thermalexpansion.tome.experience.0"));
        tooltip.add(StringHelper.localize("info.thermalexpansion.tome.experience.1"));
        tooltip.add(StringHelper.getNoticeText("info.thermalexpansion.tome.experience.2"));
        tooltip.add(StringHelper.localizeFormat("info.thermalexpansion.tome.experience.a." + (isEmpowered(stack) ? 1 : 0), StringHelper.getKeyName(KeyBindingItemMultiMode.INSTANCE.getKey())));
    ...
    public void onUpdate(ItemStack stack, World world, Entity entity, int slot, boolean isSelected) {
        ...
        tag.setLong(TEProps.EXPERIENCE_TIMER, entity.world.getTotalWorldTime());
    }
    ...
    public FluidStack getFluid(ItemStack container) {
        ...
        return experience > 0 ? Materials.EXPERIENCE.getStack(FluidType.LIQUID, experience * CoreProps.MB_PER_XP) : null;
    }
    ...
    public int fill(ItemStack container, FluidStack resource, boolean doFill) {
        ...
        if (resource == null || (resource.getFluid() != Materials.EXPERIENCE.getFluid(FluidType.LIQUID) && !resource.getFluid().getName().equals(CoreProps.ESSENCE) && !resource.getFluid().getName().equals(CoreProps.XPJUICE))) {
            return 0;
        }
        int experience = getExperience(container);
    ...
    public FluidStack drain(ItemStack container, int maxDrain, boolean doDrain) {
        ...
        return Materials.EXPERIENCE.getStack(FluidType.LIQUID, drained * CoreProps.MB_PER_XP);
    }
    ...
    public static void config() {
        ...
        enable = ThermalExpansion.CONFIG.getConfiguration().getBoolean("EnableRecipe", category, enable, comment);
    }
